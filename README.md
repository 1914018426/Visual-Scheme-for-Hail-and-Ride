...
| 前臂方向向量 | 基于 wrist-elbow 向量描述手臂伸出方向，作为朝向锁输入 |
...
|------|----------|----------|-----------|
| **招手** | 手臂朝前上方伸出，前臂大致指向车头 | XY 分量小，Z=0.5 主导 → 向量接近 `[0, 0, 0.5]` | 夹角小，通过 |
| **走路摆臂** | 手臂在身体两侧侧向摆动 | XY 分量大 → 向量接近侧向 | 夹角大，拒绝 |
| **手臂下垂** | 前臂朝下 | XY 分量小但 θ1 低 → 已被姿态锁拒绝 | — |
